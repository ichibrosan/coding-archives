...
class localvars():
	...
	###################################
	# The root path and the library application support VPA path
	# never change. They are the top of the administrative control
	# over the location of the configuration files.
	#---------------------------------------------------------------------
	rootpath              = "/"
	LibAppSupVpa     = "Library/Application  Support/VPA/"
	#---------------------------------------------------------------------

	userpath              = os.getenv("HOME") + "/"
	
	###################################
	# These definitions control the name and location of the global
	# configuration file which may be located on a remote or local
	# file system. In this case, they default to the local file system.
	#       /Library/Application Support/VPA/global.cfg
	#------------------------------------------------------------------------------
	default_globalcfgdirpath  = rootpath + LibAppSupVpa
	default_globalcfgfilespec = rootpath + LibAppSupVpa + "global.cfg"
	#------------------------------------------------------------------------------

	######################################
	# These definitions control the name and location of the local
	# configuration file which is usually located on the local file system.
	#        /Library/Application Support/VPA/local.cfg
	#----------------------------------------------------------------------------
	default_localcfgdirpath    = rootpath + LibAppSupVpa
	default_localcfgfilespec   = rootpath + LibAppSupVpa + "local.cfg"
	#----------------------------------------------------------------------------
	default_usercfgfilespec   = userpath + ".vparc"
	default_usercfgdirpath    = userpath
	default_userdatapath       = userpath + "Sources/data"

	# declare global file and directory pointers
	localcfgfilespec   = ""		# set by GLOBAL CONFIG PROCESSING
	usercfgfilespec   = ""		# set by  LOCAL  CONFIG PROCESSING
	localcfgdirpath   = ""
	# declare the user data path pointer
	userdatapath       = ""
